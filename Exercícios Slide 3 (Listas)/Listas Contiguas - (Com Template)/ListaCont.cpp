...
template <class T>
void ListaCont<T>::insereInicio(T val)
{
    //caso lista vazia
    if(this->ultimo == -1)
    {
...
template <class T>
void ListaCont<T>::insereUltimo(T val)
{
...
template <class T>
void ListaCont<T>::insereK(int k, T val)
{
